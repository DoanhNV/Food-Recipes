		...
		<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
			<div class="menu_section">
				...
				<ul class="nav side-menu">
					<li><a><i class="fa fa-home"></i> Thành viên <span
							class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a href="../user/list">Danh sách thành viên</a></li>
						</ul></li>
					<li><a><i class="fa fa-edit"></i> Nguyên liệu <span
							class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a href="../material/list">Danh sách nguyên liệu</a></li>
							<li><a href="../material/create">Tạo mới</a></li>
						</ul></li>
					<li><a><i class="fa fa-desktop"></i> Chủ đề <span
							class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a href="../kind/list">Tất cả chủ đề</a></li>
							<li><a href="../kind/create">Tạo mới</a></li>
						</ul></li>
					<li><a><i class="fa fa-table"></i> Danh mục công thức <span
							class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a href="../recipecate/list">Danh sách</a></li>
							<li><a href="../recipecate/create">Tạo mới</a></li>
						</ul></li>
					<li><a><i class="fa fa-bar-chart-o"></i> Danh mục mẹo vặt
